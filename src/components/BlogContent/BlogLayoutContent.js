                            ...
                            <div className="article-footer">
                                ...
                                <div className="article-share">
                                    <ul className="social">
                                        ...
                                        <li>
                                            <a href={`https://www.facebook.com/sharer/sharer.php?u=${`https://bluetickpost.com/blog${props.pageContext.frontmatter.path}`}`} className="facebook">
                                                <i className='bx bxl-facebook'></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href={`https://twitter.com/intent/tweet?url=${`https://bluetickpost.com/blog${props.pageContext.frontmatter.path}`}&text=${props.pageContext.frontmatter.title}`} className="twitter">
                                                <i className='bx bxl-twitter'></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href={`https://www.linkedin.com/shareArticle?mini=true&url=${`https://bluetickpost.com/blog${props.pageContext.frontmatter.path}`}`} className="linkedin">
