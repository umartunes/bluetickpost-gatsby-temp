            ...
            <Document>
                <Page size="A4" style={styles.page}>
                    ...
                    <View style={styles.descriptions}>
                        ...
                        <Text style={styles.note}>You would receive a call from BlueTickPost Office for a Basic Test, and Form Submission date. If you do not receive a call from us by <Text style={styles.strongUnderline}>{application.lastDateOfFormSubmission}</Text>. Contact us at the phone number given below.</Text>
                        ...
                        <View style={styles.paragraphsGroup}>
                            ...
                            <Text style={styles.textPara}>1) Bring 1 color copy of this document for attestation from <Text style={styles.bold}>BlueTickPost</Text> Office. </Text>
