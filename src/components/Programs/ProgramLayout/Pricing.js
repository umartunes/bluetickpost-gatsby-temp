            ...
            <div className="container">
                <div className="row">
                    <div className="col">
                        ...
                        <p className="text-center ">Our programs are priced to be affordable and help more students get into Coding! </p>
                        <p className="text-center mb-5">All of group courses will have a maximum of 6 students, each class is led by an Instructor and a Leader in Training. </p>
